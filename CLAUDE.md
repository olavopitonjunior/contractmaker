...
Detalhe completo em [docs/agente-ia.md](docs/agente-ia.md) — loop tool-use, modelo padrão, budget por contrato, as 19 tools, pré-carregamento de contexto e knowledge base.
...
Detalhe completo em [docs/editor-google-docs.md](docs/editor-google-docs.md) — orquestração do editor, aba Configurações, pipelines de criação/import/versão e as armadilhas do `replaceAllText`.
