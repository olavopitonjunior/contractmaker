...
// Onde a imobiliária recebe a comissão NÃO mora aqui: é dado fixo do cadastro
// (`Organization.pixAddressKey`/`bank*`, tela /settings/perfil) — ver
// `lib/contracts/org-recebimento.ts`. Passou por `contractDefaultsJson.
// locacao_recebimento` no #518 por menos de um dia; medido em produção antes
// de mover: nenhuma org tinha preenchido.
