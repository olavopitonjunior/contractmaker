...
export type AuditAction =
  ...
  // Superlógica (ERP) — conta por org + exportação de vendas
  | "SUPERLOGICA_ACCOUNT_CONNECTED"
  | "SUPERLOGICA_ACCOUNT_CONNECT_FAILED"
  | "SUPERLOGICA_ACCOUNT_DISCONNECTED"
  | "SUPERLOGICA_SETTINGS_UPDATED"
  | "SUPERLOGICA_VENDA_PREVIEW"
  | "SUPERLOGICA_VENDA_CREATED"
  | "SUPERLOGICA_VENDA_FAILED"
  | "SUPERLOGICA_VENDA_CANCELLED"
  | "SUPERLOGICA_COMISSAO_LIQUIDADA"
