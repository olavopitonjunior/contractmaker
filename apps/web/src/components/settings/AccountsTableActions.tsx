      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            disabled={busy}
            title="Mais ações"
            className="inline-flex h-8 w-8 items-center justify-center rounded-md text-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
          >
            {busy ? (
