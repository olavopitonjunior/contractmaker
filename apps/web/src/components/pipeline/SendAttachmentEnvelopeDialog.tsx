    ...
    try {
      ...
      if (!res.ok) {
        if (res.status === 422 && data.missing) {
          toast.error(
            `${data.missing.length} signatário(s) sem e-mail válido`
          );
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <Input
                      ...
                      value={s.name}
                      onChange={(e) =>
                        updateSigner(s.id, { name: e.target.value })
                      }
                    />
                    <Input
                      type="email"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <NativeSelect
                value={authMethod}
                onChange={(v) =>
                  setAuthMethod(v as typeof authMethod)
                }
                options={[
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={submitting || pdfAttachments.length === 0}
          >
